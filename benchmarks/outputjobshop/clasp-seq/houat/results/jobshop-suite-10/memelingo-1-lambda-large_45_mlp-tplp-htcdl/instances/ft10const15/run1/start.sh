...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=45 --approach=mlp-tplp-htcdl  \
     )

input=( "../../../../../../../../../../examples/benchmarks/job-shop/instances/ft10const15.lp" "../../../../../../../../../../examples/benchmarks/job-shop/job-shop.lp" )
