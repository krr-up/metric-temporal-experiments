...
runner=( "../../../../../../../../../../programs/runlim" \
  ...
  0 --project=show --stats -c lambda=4 --approach=mlp-tplp-htcdl --timepoint-limit=440 \
     )

input=( "../../../../../../../../../../../examples/dentist/instances/size-4.lp" "../../../../../../../../../../../examples/dentist/dentist-goal.lp" "../../../../../../../../../../../examples/dentist/dentist.lp" )
