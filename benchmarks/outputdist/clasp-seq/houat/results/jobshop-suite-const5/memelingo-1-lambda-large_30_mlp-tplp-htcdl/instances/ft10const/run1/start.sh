...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=30 --approach=mlp-tplp-htcdl -c const_size=5 \
     )

input=( "../../../../../../../../../../examples/benchmarks/job-shop/instances/ft10const.lp" "../../../../../../../../../../examples/benchmarks/job-shop/job-shop.lp" )
