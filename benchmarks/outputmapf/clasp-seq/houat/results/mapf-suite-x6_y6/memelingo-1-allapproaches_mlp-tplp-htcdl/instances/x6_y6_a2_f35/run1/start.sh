...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=10 --approach=mlp-tplp-htcdl --timepoint-limit=525 \
     )

input=( "../../../../../../../../../../examples/benchmarks/mapf/instances/x6_y6_a2_f35.lp" "../../../../../../../../../../examples/benchmarks/mapf/mapf.lp" )
