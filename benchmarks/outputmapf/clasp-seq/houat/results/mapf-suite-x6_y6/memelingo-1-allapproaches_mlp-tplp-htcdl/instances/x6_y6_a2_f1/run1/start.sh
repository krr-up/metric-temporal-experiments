...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=10 --approach=mlp-tplp-htcdl --timepoint-limit=15 \
     )

input=( "../../../../../../../../../../examples/benchmarks/mapf/instances/x6_y6_a2_f1.lp" "../../../../../../../../../../examples/benchmarks/mapf/mapf.lp" )
