...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=10 --approach=mlp-tplp-htcdl --timepoint-limit=75 \
     )

input=( "../../../../../../../../../../examples/benchmarks/mapf/instances/x6_y6_a1_f5.lp" "../../../../../../../../../../examples/benchmarks/mapf/mapf.lp" )
