...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=10 --approach=mlp-tplp-htcdl --timepoint-limit=225 \
     )

input=( "../../../../../../../../../../examples/benchmarks/mapf/instances/x6_y6_a4_f15.lp" "../../../../../../../../../../examples/benchmarks/mapf/mapf.lp" )
