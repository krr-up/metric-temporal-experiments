...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=10 --approach=mlp-tplp-htcdl --timepoint-limit=600 \
     )

input=( "../../../../../../../../../../examples/benchmarks/mapf/instances/x6_y6_a2_f40.lp" "../../../../../../../../../../examples/benchmarks/mapf/mapf.lp" )
