...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=10 --approach=mlp-tplp-htcdl --timepoint-limit=300 \
     )

input=( "../../../../../../../../../../examples/benchmarks/mapf/instances/x6_y6_a3_f20.lp" "../../../../../../../../../../examples/benchmarks/mapf/mapf.lp" )
