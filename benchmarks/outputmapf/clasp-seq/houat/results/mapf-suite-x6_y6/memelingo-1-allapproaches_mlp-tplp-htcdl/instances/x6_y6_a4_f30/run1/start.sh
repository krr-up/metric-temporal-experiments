...
runner=( "../../../../../../../../../programs/runlim" \
  ...
  --project=show --stats -c lambda=10 --approach=mlp-tplp-htcdl --timepoint-limit=450 \
     )

input=( "../../../../../../../../../../examples/benchmarks/mapf/instances/x6_y6_a4_f30.lp" "../../../../../../../../../../examples/benchmarks/mapf/mapf.lp" )
