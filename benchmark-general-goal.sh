...
echo "======== Size 1 ============" >> general-clingo-out-goal.txt
python -m clingo examples/dentist/dentist.lp  examples/dentist/dentist-goal-eventually-body.lp --output=reify | python -m clingodl 0 - ./src/encodings/mlp-tplp-htc-dl.lp -c lambda=4 -c v=110 --stats -c size=1 -q >> general-clingo-out-goal.txt 2>&1
echo "======== Size 5 ============" >> general-clingo-out-goal.txt
python -m clingo examples/dentist/dentist.lp  examples/dentist/dentist-goal-eventually-body.lp --output=reify | python -m clingodl 0 - ./src/encodings/mlp-tplp-htc-dl.lp -c lambda=4 -c v=550 --stats -c size=5 -q >> general-clingo-out-goal.txt 2>&1
echo "======== Size 10 ============" >> general-clingo-out-goal.txt
python -m clingo examples/dentist/dentist.lp  examples/dentist/dentist-goal-eventually-body.lp --output=reify | python -m clingodl 0 - ./src/encodings/mlp-tplp-htc-dl.lp -c lambda=4 -c v=1100 --stats -c size=10 -q >> general-clingo-out-goal.txt 2>&1
